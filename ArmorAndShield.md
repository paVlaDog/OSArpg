...
## Правила
КФЗ - Класс физической защиты. Чтобы попасть по вам атакой, противник должен превзойти ваше значение КФЗ. КФЗ может быть дробным, в таком случае оно округляется вниз. Стандартный КФЗ любого существа - 5. Также к КФЗ прибавляется ваша Ловкость, КД брони и различные бонусы от способностей, если они есть.  
...
## Виды доспехов:
- Стёганный                             (Лёгкий, КД +2) 
- Кожанный                              (Лёгкий, КД +3)
- Клёпанная кожа                        (Лёгкий, КД +4)
- Мифриловый полукольчужный             (Лёгкий, КД +5)

- Шкурный                               (Средний, КД +4)
- Полукольчужный (Кольчужная рубаха)    (Средний, КД +5)
- Полуламеллярный (Кираса)              (Средний, КД +6)
- Ламинарный                            (Средний, КД +7) 
- Полулаты                              (Средний, КД +8)
