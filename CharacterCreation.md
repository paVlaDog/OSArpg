...
- После получения класса и расы продумайте персонажа и его предысторию. В разделе Социальная часть прописано, что такое аспекты. У вас должно быть хотя бы 7 аспектов, хотя бы 4 из которых должны относиться к чертам характера. Желательно записать аспекты на отдельных небольших карточках, чтобы любой игрок за столом мог в любой момент их посмотреть. Также, помимо аспектов, у вашего персонажа должна быть цель/идеал (основная идея, которая толкает его на приключения и исходя из которой он будет принимать большинство решений) и мировоззрение(Некий моральный компас. Что для вашего персонажа допустимо, а что уже перебор). Слабости, привязанности и прочее - по желанию.
- Далее вам выдаётся 25 очков умений для выбора навыков, владения и распределения характеристик. В разделе Формулки описаны правила выбора, в разделах Характеристики, Навыки и Владения - из чего нужно выбирать).  
...
У вас есть счётчик вдохновений. Вдохновение можно потратить на перебрасывание любого куба, получение дополнительно единицы действия или можно потратить несколько вдохновений за совершения уникального действия, позволяющего немного нарушить правила игры(на усмотрение мастера).  
Вы получаете 1 вдохновения со старта, а дальше вы мастер может выдавать вдохновения за хороший отыгрыш аспектов и забирать за противоречие аспектам.  

### Формулки:

Стартовые характеристики закупаются на 25 очков умений.   
1 очко умений = +0.5 к хар-ке или +1 навык или улучшения костей здоровья или +2 владения.   
Нельзя со старта повышать характеристики более чем до +4 и нельзя повышать навыки до компетентности и выше. (Если ваши способности класса/расы не утверждают обратное)
...
Существуют характеристики (числовые значения от -2 до +10), прибавляются к почти любым проверкам, дают бесплатное владение соответсвующей хар-ки за каждый +1, а также дополнительные бонусы. Нельзя получить значение характеристики выше +4 на 1ом уровне, выше +6 до 5ого уровня, выше +8 до 10ого, выше +10 на любом уровне прокачки.
...
- Каждый уровень вы бросаете 1к20. Если выпало значение от 1 до ИНТ, то вместо 2 очков умений вы получаете 3. При отрицательных значениях интелекта можно добиться противополжного эффекта.
...
Вы не можете получить владение, если ваш бонус хар-ки ниже +6 и мастерство, если ваш бонус ниже +8.
...
***
Для прокачки Ветеран в оружейных навыках вы должны иметь +6 Силы/Ловкости, для Мастера - +8 Силы/Ловкости.  
Кость урона оружия зависит от максимального уровня владения каким-либо видом оружия среди всех свойств вашего оружия и вида оружия (Парное/Простое/Двуручное).  
* Урон парным: (1к4+МОД/2 | 1к6+МОД/2 | 1к8+МОД/2)  
* Урон простым: (1к6+МОД | 1к10+МОД | 1к12+МОД)
* Урон двуручным: (1к10+МОД | 2к6+МОД | 2к8+МОД)

Пример: У вас есть владение парными(Ученик) и Фехтовальным(Ветеран).  
...
Если вы используете Сай(Урон:0, парное, фехтовальное), то вы можете использовать его на уровне Ветеран(т.к. у вас Фехтовальное оружие на уровне Ветеран), следовательно сай для вас - Парное, Ветеран(1к6+МОД/2).  
***
...
- Знание улиц (Эрудиция: Социальные науки)
- Знание высшего света (Эрудиция: Социальные науки)
- Знание искусства (Эрудиция: Социальные науки)
- Знание географии (Эрудиция: Социальные науки)
- Знание истории (Эрудиция: Социальные науки)
- Знание теологии (Эрудиция: Социальные науки)
- Знание технологий (Эрудиция: Естественные науки)
- Знаний магических наук (Эрудиция: Естественные науки)
- Знание точных наук (Эрудиция: Естественные науки)
- Знание природы (Эрудиция: Естественные науки)
- Знание планов (Эрудиция: Естественные науки)

- Знание общего языка (Харизма/Эрудиция: Социальные науки) 
- Знание человеческого языка (Харизма/Эрудиция: Социальные науки) 
- Знание языка Диких (Харизма/Эрудиция: Социальные науки)
- Знание говора Морозных земель (Харизма/Эрудиция: Социальные науки) 
- Знание рыков Гноллов (Харизма/Эрудиция: Социальные науки) 
- Знание языка Ракшасс (Харизма/Эрудиция: Социальные науки) 
- Знание языка Арахнид (Харизма/Эрудиция: Социальные науки) 
- Знание языка Кобольдов (Харизма/Эрудиция: Социальные науки) 
- Знание языка Капп (Харизма/Эрудиция: Социальные науки) 
- Знание языка Сарангаев (Харизма/Эрудиция: Социальные науки) 
- Знание змеинного наречия (Харизма/Эрудиция: Социальные науки) 

### Примеры персонажей первого уровня(без учёта умений классов и рас):  
Плут Мефисто: кость 1к8 (2), хар-ки: -1 +4 +2 0 +2 +2 (18), 33 хп, 5 маны, 0 заклинаний, 14 КФЗ, 2 КМЗ.  
Убеждение 1, Ловкость рук 1, Незаметность 1.  
Фехтовальное, Луки и арбалеты, Взлом, Лёгкие доспехи, Пивовар (2, одно бесплатное от повышения кости) 

Ведьма Таша: кость 1к6 (0), хар-ки: -2 0 +1 +4 +3 +4 (20), 23 хп, 33 маны, 4 заклинания, 10 КФЗ, 4 КМЗ.  
Эрудиция: Естественные науки 1, Обман 1, Анализ 1, Воля 1  
Нестандартное, Теология, Магия, Ураган, Медицина, язык Диких (3)

Варвар Горо: кость 1к10 (5), хар-ки: +4 +1 +3 -1 +1 0 (16), 43 хп, 2 маны, 0 заклинаний, 11 КФЗ, 0 КМЗ.  
Атлетика 1, Бдительность 1  
Парное, Двуручное, Простое, Тяжёлые доспехи, Средние доспехи, Лекарь (2, два бесплатных от повышения кости) 
***
