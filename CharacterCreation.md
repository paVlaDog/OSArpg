...
- Далее вам выдаётся 25 очков умений для выбора навыков и распределения характеристик. В разделе Формулки описаны правила выбора, в разделах Характеристики и Навыки - из чего нужно выбирать).  
...
- Также, вы можете выбрать владения. За каждую единицу в характеристике вы получаете +1 владение этой характеристики или её навыка. (Например, если у меня Сила +3, то я могу взять 3 владения Силы/Атлетики). Также вы можете выбрать 1 дополнительное любое владение за каждую единицу интелекта. У вас могут остаться непотраченные очки владений.
...
***
Стартовое количество заклинаний: ИНТ   
Большинство магических классов позволяют получить дополнительные заклинания со старта.   
Вы можете отложить выбор заклинаний до получения доступа к более выкоуровненым заклинаниям.  
***
...
При повышении любой характеристики на чётное значение вы можете получить владение соответствующей характеристики. Вы можете отложить прокачку владения.
...
***
Для прокачки Ветеран в оружейных навыках вы должны иметь +5 Силы/Ловкости, для Мастера - +7 Силы/Ловкости.  
...
***
Для прокачки Адепта в мистических навыках вы должны иметь +5 Мудрости, для Мастера - +7 Мудрости.  
...
Плут Мефисто: кость 1к8 (2), хар-ки: -1 +4 +2 0 +2 +3 (20), 33 хп, 5 маны, 0 заклинаний, 17 КФЗ, 12 КМЗ.  
...
Ведьма Таша: кость 1к6 (0), хар-ки: -2 +1 +1 +4 +3 +4 (22), 23 хп, 33 маны, 6 заклинаний, 13 КФЗ, 13 КМЗ.  
Эрудиция: Естественные науки 1, Обман 1, Анализ 1.  
Нестандартное, Фехтовальное, История, Теология, Этикет и Магия, Средние доспехи, Ураган, Медицина, Артист, 3 языка, (1МДР), (3ЛЮБ)  

Варвар Горо: кость 1к10 (5), хар-ки: +4 +1 +3 -1 +1 +1 (18), 43 хп, 2 маны, 0 заклинаний, 19 КФЗ, 11 КМЗ.  
