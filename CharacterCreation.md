...
- Интелект: +кол-во известных владений, +кол-во максимум свободных владений, +кол-во известных заклинаний
- Мудрость: +мана, +хил маны, +попадание и +урон магией, +кол-во известных манёвров
...
- Вы можете оставить до ИНТ очков владений непотраченными. Это называется "Свободные владения".
