...
*Удар двойных клыков* - Можно использовать только с парным оружием. Вы наносите двумя оружиями сразу. Вы бросаете кубы урона и прибавляете модификаторы за оба оружия, но защита противника учитывается только 1 раз. 1р/бой.
