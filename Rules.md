...
<!-- 
## Базовая школа магии
- Даже если вы не являетесь заклинателем, вы обязаны выбрать Базовую Школу (БаШ). Она должна совпадать с вашим мистическим владением, если оно есть.
- В бою вы можете действием потратить часть маны, чтобы получить усиления, в зависимости от вашей БаШ.
	- Водоворот: +2 КМЗ на 3 хода за 8 маны.
	- Поток: +2 к бонусу каста на 3 хода за 8 маны.
	- Пустошь: Лечение на 1 хит за каждые 2 маны. Не более 16 маны. 
	- Ураган: +1МС на 3 хода за 8 маны.
	- Горнило: +5 урон огнём от следуюшей атаки за 8 маны.
	- Сияние: Вы можете использовать свою руку как источник тусклого света, 7 ходов, 8 маны.
	- Грань: Вы получаете дополнительное действие и возвращаете потраченное на использование этого навыка за 16 маны. -->
...
- Если под эффектом Без сознания ваши хиты поднялись до 1/4 от максимума или выше, то вы воскресаете и можете совершать действия по обычным правилам начиная со следующего хода.
