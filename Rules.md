...
- Вы можете потратить одно или несколько действий и совершить *Перемещение*, *Рывок*, *Атаку*, *Использование заклинания, влияния, манёвра или способности*, *Подготовку*, *Помощь*.
	- *Перемещение* тратит 1 действие и позволяет переместиться на вашу МС. Вы не можете использовать больше 2ух перемещений в ход.
	- Почти все атаки тратят 2 действия за исключением атак парным оружие - они тратят всего 1 действие. Вне зависимости от вида оружия вы не можете атаковать одним и тем же оружием дважды за ход (Если способность прямо не позволяет обратное). Более подробные правила атаки описаны ниже.
...
- Простое и двуручное оружие тратит 2 действия на атаку, парное - 1. Вы не можете атаковать одним и тем же оружием дважды за ход, если способности прямо не позволяют вам сделать обратное.
...
- Стартовые манёвры:
- *Отход*(1) - Тратит 1 действие, все перемешения до конца хода не провоцируют атак.
- *Рывок*(1) - Тратит 1 действие, вы можете дополнительно переместиться на МС, но получаете -3КМЗ и -3КФЗ от любых атак.
...
- *Захват*(1) - Тратит 2 действия, Соревнование Атлетики против Атлетики/Акробатики противника(На его выбор). При успехе противник обездвижен и не может атаковать, а атаки по нему совершаются с преимуществом. Успешный спасбросок от обездвиживания снимает оба эффекта.
- *Оборона*(1) - Тратит 1 действие, запрещает перемещаться и атаковать до начала следующего хода, но взамен вы получаете +1КФЗ(от парирования) и по вам не наносят провоцированные атаки. Щит, зачастую, даёт бонус к обороне.
