...
- Действием вы можете сделать *Перемещение*, *Рывок*, *Атаку*, *Использование заклинания, влияния, манёвра или способности*, *Подготовку*, *Помощь* (Все действия описаны ниже).
...
- Сила заклинания: 1к20 + бонус каста - Сложность заклинания.
- Попадание заклинанием не направленным на противников: 0 VS Сила заклинания
- У любого существа есть КМЗ - Класс магической зашиты. Со старта - МДР + КО(Класс оберега) + особые бонусы.
- Попадание заклинанием направленным на противников: КМЗ цели + ЛОВ цели, если можно уклониться VS Сила заклинания.
...
- 1 - -1 к ТЕЛ
- 2 - -МОД к атакам и касту заклинаний
- 3 - -50%МС
