...
- *Засада*(1) - Тратит 2 действия. Проверка скрытности, сложность проверки определяет мастер. При успехе вы считаетесь *Незамеченным*, если вы совершите атаку не выходя из этого состояния, то атака будет с преимуществом.
