...
- Привал - Короткая передышка от приключенческих дел, которая позволит восстановить силы. Вы должны находится в безопасном и удобном месте, отдыхать не менее часа и не заниматься сложной деятельностью. Привал позволяет вам снять 1 истощение или восстановить 2\*ЖСИ хп и МСИ маны. Вы не можете отдыхать слишком часто. Третий и последующие привалы в день не дадут вам никаких преимществ и ничего не восстановят.
- Отдых - Длительный привал, во время которого можно выспаться и восстановить силы. Вы должны спать не менее 8 часов и находиться в безопасном и удобном месте. Отдых востанавливает 4\*ЖСИ хп, 2\*МСИ маны и снимает один уровень истощения. Отдых можно устроить не более 1 раза в день. Отдых считается началом нового дня, все использованные способности с меткой "n раз в день" восстанавливаются после отдыха.
...
<!-- - Необходимое время между отдыхами можно варьировать. Если игровое время движется крайне быстро и у героев в среднем бои 1 раз в день, то преимущества от Привала можно получать лишь раз в день, а от Отдыха лишь раз в 3 дня. Если боёв слишком много, то можно сделать наоборот и сократить время между Привалами и Отдыхами.   -->
...
## Выброс магии:
- К каждой школе магии привязан определённый спектр эмоций. Если вы испытываете крайне сильную эмоцию, связанную с одной из школ, то мастер может попросить вас бросить 1к12. При выпадении 11 или 12 происходит выброс магии.
- При выбросе вы используете случайное заклинание ученика подходящей школы на случайную цель, затрачивая лишь половину необходимой маны. Мастер может наложить дополнительные ограничения на подходящие для выброса заклинания и цели на своё усмотрение.
- Вы можете реакцией совершить дополнительную проверку Воли для попытки отменить выброс, дополнительную проверку Чувства магии для возможности выбрать используемое заклинание (включая заклинания Адепта и Мастера) или дополнительную проверку Воли для возможности выбрать цель выброса. Сложность каждой проверки определяет мастер, для каждой проверки необходимо потратить 1 реакцию.
- Выброс магии может произойти как у магических, так и у немагических классов, но не более одного раза в день.
...
- Если вы нанесли превзошли КФЗ противника втрое или больге, то считается, что вы полностью попали.

## Соревнования:

- Иногда две и более существ совершают действия, противодействующие друг другу. В таких случаях происходит *Соревнование* - обе стороны бросают проверки, у кого значение больше - тот и победил. 
...
- *Оборона*(1) - Тратит 1 действие, запрещает перемещаться и атаковать(не считая провоцированные атаки) до начала следующего хода, но взамен вы получаете +1КФЗ и с преимуществом наносите провоцированные атаки. Любой щит(кроме баклера), даёт +1КФЗ в обороне.
- *Борьба*(1) - Вы можете попытаться забороть противника, сбив его с ног, сместив на одну клетку, совершив Захват или попытаться сделать что-то ещё(на усмотрение мастера). Соревнование Атлетики против Атлетики/Акробатики противника(На его выбор). Захват стоит 2 действия, сбитие и смещение - 1. Владение навыком борьба позволяет использовать этот навык или защищатьсяот него с преимуществом
...
- Заклинания бывают двух видов - заклятия(Например, Стрела Хлада или Восстановление) и модификаторы(Например, Усиленное восстановление или Вечный лёд).
...
- Если в заклинании используется какая-либо кость (Например, урон стрелы хлада СЗ+\[1к10\]), то при нанесении более половины урона кости(В примере - 6 и более) вы частично попали, если урон превысил урон кости (В примере - 11 и более) - вы полностью попали. Если кости нет(например, вы не используете фокусировку), то вы не можете частично или полностью попасть.
- Некоторые предметы, такие как магический посох или жезл, считаются магической фокусировкой. Заклинания, в требованиях которых есть пометка "необ. фокусирока" не могут быть созданы, если вы не используете магическую фокусировку в момент каста. Заклинания, в конце которых дописано "Фокусировка:" приобретают допольнительные эффекты при использовании фокусировки.
