...
- У персонажей есть параметр восстановления равный (Бросок кости хитов * (ХП / 30 + 1) + ЗДР * (ХП / 50 + 1)). Т.Е. у персонажа с 65ХП, костью 1к8 и +2ЗДР, параметр восстановления равен 3к8+2*2.
- Передышка - короткий привал, который позволит восстановить силы. Вы должны находится в безопасном и удобном месте, отдыхать не менее часа и не заниматься сложной деятельностью. Передышка позволяет вам снять 1 истощение или восстановить (ВОССТ) хп. Вы не можете отдыхать слишком часто. Третья и последующие передышки в день не дадут вам никаких преимществ и ничего не восстановят.
- Отдых - привал, во время которого вы можете выспаться. Вы должны спать не менее 6 часов и находиться в безопасном и удобном месте. Отдых востанавливает ВОССТ*2 хп. Отдых можно устроить не более 1 раза в день. Отдых считается началом нового дня, все использованные способности с меткой "n раз в день" восстанавливаются после отдыха.
...
- В ход можно сделать 1 перемещение, 1 действие и 1 малое действие (бонусное действие или реакция).
...
- Правила *Атаки*, *Использование манёвра* и *Использования заклинаний* описанны ниже.
...
- *Отход*(1) - Позволяет вам не получать провоцированные атаки до конца хода.
...
## Укрытия:
- По цели с частичным укрытием дальнобойные атаки совершаются с помехой. Цель получает укрытие на три четверти если препятствие 
