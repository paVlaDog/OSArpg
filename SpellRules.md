...
- Ваше кол-во заклинаний равно ИНТ + бонус от класса(Если вы магический класс - скорее всего у вас будет бонус на кол-во заклинаний).
...
- При выборе заклинания, вы выбираете название и ранг и тратите 1 слот известных заклинаний. Вы получаете все заклинания этого названия и ранга.
...
- Колонка МДР показывает, можно ли от этого заклинания защититься при помощи КМЗ.
