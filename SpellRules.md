...
- **Важно!!!** - Я решил откатиться к идее, где все заклинания отдельно и каждая строчка - это отдельное заклинание, но оформленно в стиле "1 заклинание - много вариаций". Поэтому, при выборе заклинания заклинания записывайте что вроде "Ледяная стрела, адепт, 2".
- Со старта вы можете выбрать заклинания в количестве вашего стартового максиумума заклинаний.
- Вы не можете получить для какого-то заклинания ранг Адепта или Мастера, если у вас нет предыдущих рангов для этого заклинания.
- Вы не можете получить для какого-то заклинания ранг Адепта или Мастера, если вы не достигли Адепта или Мастера в этой школе(во владениях).
- Пример: Я Адепт Пустоши и могу выбрать 3 заклинания. В таком случае я выбираю "Стрела хлада-Ученик"(3 заклинания), "Стрела хлада-Адепт"(3 заклинания) и "Ледяная руна-Ученик"(2 заклинания). Суммарно я получил 8 вариаций закинаний, но считается, что кол-во заклинаний у меня - 3.
- Колонка "Сложность" означает сложность каста.
- Колонка КМЗ показывает, можно ли от этого заклинания защититься при помощи КМЗ.
- Колонка ЛОВ показывает, будет ли при защите к КМЗ прибавляться ЛОВ.
- Цена означает расход маны.
- Расст - Расстояние применения в клетках/метрах.
- Время - Что нужно потратить для использования этого заклинания(Действие/Малое действие/Реакцию/Какое-то кол-во минут). 
